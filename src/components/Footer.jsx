                ...
                <div className="xui-row">
                    <div className="xui-lg-col-4 xui-col-12">
                        ...
                        <div className="xui-mt-1 xui-d-flex xui-flex-ai-center xui-grid-gap-1">
                            ...
                            <Link to='https://www.facebook.com/profile.php?id=61562715989423&mibextid=ZbWKwL' target="_blank">
                            ...
                            <Link to='https://www.instagram.com/_begorah?igsh=OWFvbmxheHo2YWR6' target="_blank">
                            ...
                            <Link to='https://www.linkedin.com/company/begorah-ltd/' target="_blank">
