            ...
            <section className="xui-pt-5 xui-pb-2 xui-container">
                ...
                <div className="xui-d-grid xui-lg-grid-col-3 xui-grid-col-1 xui-grid-gap-1 xui-mt-3">
                    <div className="xui-p-1 xui-bdr-rad-half xui-bdr-w-1 xui-bdr-s-solid" style={{borderColor: '#D3D3D380'}}>
                        ...
                        <p className='xui-font-sz-100 xui-opacity-8 xui-line-height-1-half xui-mt-1'>HR Manager</p>
                    ...
                    <div className="xui-p-1 xui-bdr-rad-half xui-bdr-w-1 xui-bdr-s-solid" style={{borderColor: '#D3D3D380'}}>
                        ...
                        <p className='xui-font-sz-100 xui-opacity-8 xui-line-height-1-half xui-mt-1'>Student</p>
                    ...
                    <div className="xui-p-1 xui-bdr-rad-half xui-bdr-w-1 xui-bdr-s-solid" style={{borderColor: '#D3D3D380'}}>
                        ...
                        <p className='xui-font-sz-100 xui-opacity-8 xui-line-height-1-half xui-mt-1'>Math Teacher</p>
